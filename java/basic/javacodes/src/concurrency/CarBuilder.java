	...
	public void run() {
		try {
			while(!Thread.interrupted()) {
				...
				System.out.print("ChassisBuilder created " + c);
				carQueue.put(c);
			}
...
class DriveTrainRobot extends Robot {
	...
	protected void performService() {
		System.out.print(this + " installing DriveTrain");
...
class WheelRobot extends Robot {
	...
	protected void performService() {
		System.out.print(this + " installing Wheels");
