        ...
        (function (directives) {
            ...
            var SimplePagingDirective = (function () {
                function SimplePagingDirective() {
                    ...
                    directive.template = '\
            <ul class="pager">\
                <li ng-if="indexVM.page == 1" class="disabled"><a href="">FirstPage</a></li>\
                <li ng-if="indexVM.page > 1"><a href="" ng-click="indexVM.page=1">FirstPage</a></li>\
                ...
                <li ng-if="indexVM.page >= indexVM.pageCount" class="disabled"><a href="">LastPage</a></li>\
                <li ng-if="indexVM.page < indexVM.pageCount"><a href="" ng-click="indexVM.page=indexVM.pageCount">LastPage</a></li>\
                <li>&nbsp&nbsp&nbsp&nbsp{{indexVM.page}}/{{indexVM.pageCount}}&nbsp&nbsp&nbsp&nbsp</li>\
                <li><input type="number" ng-model="pageInput" min="1" style="width:60px"></li>\
                <li ng-if="pageInput-0 > indexVM.pageCount || pageInput-0 < 1" class="disabled"><a href="">Jump</a></li>\
                <li ng-if="pageInput-0 <= indexVM.pageCount && pageInput-0 >= 1"><a href="" ng-click="indexVM.page = pageInput-0" >Jump</a></li>\
            </ul>';
                    return directive;
                }
